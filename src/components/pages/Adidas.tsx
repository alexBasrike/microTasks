...
export const Adidas = () => {
    return (
        <div>
            ...
            <ul style={{display: 'flex', flexWrap: 'wrap', gap: '10px', margin: '0', padding: '0', listStyle: 'none'}}>
                {adidasArr.map((adidas) => {
                    return <li key={adidas.id}>
                        <Link to={`/adidas/${adidas.id}`}>
                            <img src={adidas.picture} alt={adidas.model} width={200} height={200}/>
                        </Link>
                    </li>
                })}
            </ul>
